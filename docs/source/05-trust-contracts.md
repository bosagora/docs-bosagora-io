...
The ultimate goal of this architecture is to enble users to build a decidable contract, which ensures safe and accurate execution, while maximizing its scalability.
